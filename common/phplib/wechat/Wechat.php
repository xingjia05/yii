<?php
namespace common\phplib\wechat;

use common\models\user\AccessToken;
...
<Nonce><![CDATA[%s]]></Nonce>
    ...
    protected function setCache($cachename,$value,$expired){
        return AccessToken::setAccessToken($cachename, $value, $expired);
    }
    ...
    protected function getCache($cachename){
        return AccessToken::getAccessToken($cachename);
    }
